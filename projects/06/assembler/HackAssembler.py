        ...
        for index,command in enumerate(instructions):
            ...
            # 翻译C指令
                ...
                # ；号是跳转指令，取编码表找到对应的编码
                    ...
                    jump = orders[1]
                # 组合成C指令并替换掉对应的汇编指令
                instructions[index] = C + self.code.comp(comp) + self.code.dest(dest) + self.code.jump(jump)
        # 写入机器指令
...
class Code:
    def __init__(self):
        ...
        self.jumpTable = {"null":"000","JGT":"001","JEQ":"010","JGE":"011","GLT":"100","JNE":"101","JLE":"110","JMP":"111"}
